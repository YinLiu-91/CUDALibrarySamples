...
|求解器|求解时间(ms)|加速比|与petsc误差(abs)|
|--|--|--|--|
|petsc|5081.88|1|-|
|cuDSS单精度|613.924|8.277|8.478e-5|
|cuDSS双精度|736.487|6.90|2.80e-13|

各个分项的耗时统计如下图：
![](./fig/2025-11-14_07-02.png)
![](./fig/2025-11-14_07-01.png)
...
#### 参考
1. [nvidia cuDSS](https://developer.nvidia.com/cudss)
1. [CUDALibrarySamples](https://github.com/NVIDIA/CUDALibrarySamples)
